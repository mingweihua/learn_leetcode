...
public class Ques726 {

	public static void main(String[] args) {
		System.out.println(new Ques726().countOfAtoms("((N42)24(OB40Li30CHe3O48LiNN26)33(C12Li48N30H13HBe31)21(BHN30Li26BCBe47N40)15(H5)16)14"));
	}

	//思路是对的，但是考虑的情况不够，错了，直接看答案，时间紧张
	int i, n;
	String formula;
